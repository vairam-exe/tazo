    ...
    <section id="home" ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden noise-overlay">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          {/* CTA Buttons */}
          <div className="scroll-section flex flex-col sm:flex-row gap-4 justify-center">
            <button
            ...
            <button
              ...
              className="magnetic-button border border-primary/30 hover:border-primary text-white px-8 py-4 rounded-lg transition-all duration-300 hover:bg-primary/10"
            >
              Begin Your Journey
            </button>
          </div>
          ...
          {/* Stats */}
          <div className="scroll-section mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-2xl mx-auto">
